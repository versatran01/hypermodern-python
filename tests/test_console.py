...
def test_main_prints_message_on_request_error(runner: Runner, mock_requests_get):
...
def test_main_uses_specified_language(runner: Runner, mock_wikipedia_random_page):
    language = "pl"
